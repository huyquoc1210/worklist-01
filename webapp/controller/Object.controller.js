    ...
    return BaseController.extend(
      "mycompany.myapp.MyWorklistApp.controller.Object",
      {
        ...
        _onBindingChange: function () {
          ...
          var oBinding = oList.getBinding("items"); // Lấy dữ liệu từ list
         ...
         */ onPost: function (oEvent) {
          var oFormat = DateFormat.getDateTimeInstance({ style: "medium" }); // Đinh dạng ngày giờ
          var sDate = oFormat.format(UI5Date.getInstance()); // Lấy ngày giờ hiện tại
          var oObject = this.getView().getBindingContext().getObject(); //  Lấy object hiện tại
          var sValue = oEvent.getParameter("value"); //Lây giá trị từ input
          var oEntry = {
            // Tạo một object mới
          ...
          console.log(oFeedbackModel.getData()); // lấy dữ liệu của model
